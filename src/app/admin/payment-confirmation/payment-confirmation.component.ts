...
export class DialogPaymentDoneAdminPaymentConfrmComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogPaymentDoneAdminPaymentConfrmComponent>,
...
export class PaymentConfirmationComponent implements OnInit {
  ...
  paymentDoneDialog(holdername:any,pubUniqId:any,invoiceId:any,month:any): void {
    ...
    const dialogRef = this.dialog.open(DialogPaymentDoneAdminPaymentConfrmComponent, {
      width: '450px',
