...
export class BankDetailsComponent implements OnInit {
  ...
  bankSubmit() {
    ...
    if (this.bankdetailform.valid) {
      ...
      this.http.post(AppSettings.API_STARTPOINT + '/assets/api/admin/backend-admin/create_bankdetail.php', fData, httpOptions).subscribe(data => {
  ...
  updateBankForm() {
    ...
    if (this.bankdetailform.invalid) {
      ...
      this.http.post(AppSettings.API_STARTPOINT + '/assets/api/admin/backend-admin/update_bankdetail.php', fData, httpOptions).subscribe(data => {
        if (data['status_code'] == '200') {
          this.isSpinnerVisible = false;
          this.message = data['message'];
          this.dialog.open(AdminDialogDynamicComponent,
