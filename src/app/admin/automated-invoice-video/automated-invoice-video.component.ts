...
@Component({
  selector: 'app-automated-invoice-video',
  templateUrl: './automated-invoice-video.component.html',
  styleUrls: ['./automated-invoice-video.component.scss'],
...
export class AutomatedInvoiceVideoComponent implements AfterViewInit {
