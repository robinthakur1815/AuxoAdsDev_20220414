...
@Component({
  selector: 'app-acc_mgr-vertical-sidebar',
  templateUrl: './acc_mgr-vertical-sidebar.component.html',
  styleUrls: []
})

export class AccManagerSidebarComponent implements OnDestroy {
  ...
  getActiveNetworkPartner(routePath: string) {
