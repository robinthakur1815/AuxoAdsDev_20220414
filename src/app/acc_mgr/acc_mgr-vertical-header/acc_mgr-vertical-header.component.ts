...
import { AccMgrHeaderService } from './acc_mgrheader.service';
import {
  NgForm
} from '@angular/forms';

@Component({
  selector: 'app-acc_mgr-vertical-header',
  templateUrl: './acc_mgr-vertical-header.component.html',
  styleUrls: []
})

export class AccManagerAppHeaderComponent {
  ...
  constructor(private translate: TranslateService, public dialog: MatDialog, private headerService: AccMgrHeaderService) {
