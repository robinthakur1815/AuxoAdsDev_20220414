...
export class OBMAdManagerPublisherDetailsComponent implements OnInit  {
  ...
  ngOnInit() {
    ...
    this.form = this.fb.group({
      ...
      org_name:[null,[Validators.required,Validators.minLength(3),Validators.pattern("^[a-zA-Z ]+")]],
    ...
    return this.restAPI.getObmAdManagerInvitePublisherData(localStorage.getItem('uniq_id'),localStorage.getItem('useremail'), this.publisherid).subscribe((response)=>{
        if(response['status_code']=='200'){
            ...
            this.form = this.fb.group({
              ...
              org_name:[this.publisherData.pub_company,[Validators.required,Validators.minLength(3),Validators.pattern("^[a-zA-Z ]+")]],
              ...
              refferedname:[this.publisherData.refer_name],
              refferedemail:[this.publisherData.refer_email],
              refferedmobile:[this.publisherData.refer_contact]
            });
            this.isSpinnerVisible = false;
        }else{
