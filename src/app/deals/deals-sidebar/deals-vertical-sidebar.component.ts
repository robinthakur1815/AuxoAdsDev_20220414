...
import { DealsItems } from '../../shared/menu-items/deals-items';

@Component({
  selector: 'app-deals-vertical-sidebar',
  templateUrl: './deals-vertical-sidebar.component.html',
  styleUrls: []
})

export class DealsSidebarComponent implements OnDestroy {
