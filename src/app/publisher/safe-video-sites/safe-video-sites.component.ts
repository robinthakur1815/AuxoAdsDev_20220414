...
import { SafeRevenueVideoSitesService } from './safe-video-sites.service';
declare var $: any;
...
@Component({
  selector: 'app-safe-video-sites',
  templateUrl: './safe-video-sites.component.html',
  styleUrls: ['./safe-video-sites.component.scss'],
  // Tooltip start
...
export class SafeRevenueVideoSitesComponent implements OnInit {
  // Tooltip start
  ...
  constructor(private _videoSitesService: SafeRevenueVideoSitesService, private datePipe: DatePipe, public dialog: MatDialog) {Highcharts.setOptions({
            lang: {
                thousandsSep: ','
            }
        }); }
  ...
  ngOnInit() {
    ...
    //api
    this._videoSitesService.getSafeVideoSites(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
  ...
  downloadsafesites() {
    ...
    //api
    this._videoSitesService.downSafeVideoSites(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
      .subscribe(dataResult => {
