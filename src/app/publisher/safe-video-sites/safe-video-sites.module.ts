...
import { SafeRevenueVideoSitesRoutes } from './safe-video-sites.routing';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild(SafeRevenueVideoSitesRoutes)
  ],
  declarations: [SafeRevenueVideoSitesComponent]
})
export class SafeRevenueVideoSitesModule {}