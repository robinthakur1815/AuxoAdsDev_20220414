...
import { SafeRevenueDisplayAdtypesService } from './safe-display-adtypes.service';
declare var $: any;
...
@Component({
  selector: 'app-safe-display-adtypes',
  templateUrl: './safe-display-adtypes.component.html',
  styleUrls: ['./safe-display-adtypes.component.scss'],
  // Tooltip start
...
export class SafeRevenueDisplayAdtypesComponent implements OnInit {
  tablerootdata = [];
  graphrootdata = [];
  tablerootdatainner = [];
  sumupdata = [];
  ...
  constructor(private _displayAdtypesService: SafeRevenueDisplayAdtypesService, private datePipe: DatePipe, public dialog: MatDialog) {
 Highcharts.setOptions({
  ...
  ngOnInit() {
    ...
    //api
    this._displayAdtypesService.getSafeDisplayAdtypes(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
      .subscribe(dataResult => {
        ...
        if (dataResult['status_code'] == '200') {
          ...
          this.lvl2data = dataResult['data']['adtype_table_data_lvl1'];
  ...
  downloadsafeadtypes() {
    ...
    //api
    this._displayAdtypesService.downSafeDisplayAdtypes(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
      .subscribe(dataResult => {
