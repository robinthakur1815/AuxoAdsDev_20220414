...
import { ProDashAdunitService } from './prodashboard-display-adunit.service';
declare var $: any;
...
@Component({
  selector: 'app-prodashboard-display-adunit',
  templateUrl: './prodashboard-display-adunit.component.html',
  styleUrls: ['./prodashboard-display-adunit.component.scss'],
  // Tooltip start
...
export class ProDashboardDisplayAdunitComponent implements OnInit {
  ...
  constructor(private _proAdunitService: ProDashAdunitService, private datePipe: DatePipe, public dialog: MatDialog, private router: Router,private elementRef: ElementRef) { }
  // Tooltip start
...
// alert("hello");
  ...
  ngOnInit() {
    ...
    //api
    this._proAdunitService.getProAdunit(localStorage.getItem('uniq_id'), localStorage.getItem('startdate'), localStorage.getItem('enddate'))
  ...
  downloadProDevice() {
    ...
    //api
    this._proAdunitService.downProAdunit(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'))
      .subscribe(dataResult => {
