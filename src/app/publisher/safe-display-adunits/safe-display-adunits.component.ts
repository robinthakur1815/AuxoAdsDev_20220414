...
import { SafeRevenueDisplayAdunitsService } from './safe-display-adunits.service';
declare var $: any;
...
@Component({
  selector: 'app-safe-display-adunits',
  templateUrl: './safe-display-adunits.component.html',
  styleUrls: ['./safe-display-adunits.component.scss'], 
    // Tooltip start
  ...
  export class SafeRevenueDisplayUnitsComponent implements OnInit {
     // Tooltip start
  ...
  constructor(private _displayAdunitsService:SafeRevenueDisplayAdunitsService,private datePipe: DatePipe,public dialog: MatDialog) { 
...
getchart(x,y,z,level){
    ...
    ngOnInit() {
     this.isSpinnerVisible = true;
         ...
         //api
         this._displayAdunitsService.getSafeDisplayAdunit(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
   ...
   downloadsafeadunits(){
        ...
        //api
         this._displayAdunitsService.downSafeDisplayAdunits(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
            .subscribe(dataResult => {
