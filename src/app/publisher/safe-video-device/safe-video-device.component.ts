...
import { SafeRevenueVideoDeviceService } from './safe-video-device.service';
declare var $: any;
...
@Component({
  selector: 'app-safe-video-device',
  templateUrl: './safe-video-device.component.html',
  styleUrls: ['./safe-video-device.component.scss'],
  // Tooltip start
...
export class SafeRevenueVideoDeviceComponent implements OnInit {
  // Tooltip start
  ...
  constructor(private _videoDeviceService: SafeRevenueVideoDeviceService, private datePipe: DatePipe, public dialog: MatDialog) { 
...
Highcharts.setOptions({
  ...
  ngOnInit() {
    ...
    //api
    this._videoDeviceService.getSafeVideoDevice(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
  ...
  downloadsafedevice() {
    ...
    //api
    this._videoDeviceService.downSafeVideoDevice(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
      .subscribe(dataResult => {
