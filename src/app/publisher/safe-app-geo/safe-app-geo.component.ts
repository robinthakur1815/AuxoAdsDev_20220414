...
import { SafeRevenueAppGeoService } from './safe-app-geo.service';
declare var $: any;
...
@Component({
  selector: 'app-safe-app-geo',
  templateUrl: './safe-app-geo.component.html',
  styleUrls: ['./safe-app-geo.component.scss'],
  // Tooltip start
...
export class SafeRevenueAppGeoComponent implements OnInit {
  // Tooltip start
  ...
  constructor(private _displayAppService: SafeRevenueAppGeoService, private datePipe: DatePipe, public dialog: MatDialog) {Highcharts.setOptions({
            lang: {
                thousandsSep: ','
            }
        }); }
  ...
  ngOnInit() {
    ...
    //api
    this._displayAppService.getSafeAppGeo(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
  ...
  downloadsafegeo() {
    ...
    //api
    this._displayAppService.downSafeAppGeo(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
      .subscribe(dataResult => {
