...
import { SafeVideoOverviewService } from './safe-video-overview.service';
...
@Component({
    selector: 'app-safe-video-overview',
    templateUrl: './safe-video-overview.component.html',
    styleUrls: ['./safe-video-overview.component.scss'],
    // Tooltip start
...
export class SafeVideoOverviewComponent implements OnInit {
    // Tooltip start
    ...
    constructor(breakpointObserver: BreakpointObserver, private _adxcontentoverviewService: SafeVideoOverviewService, private datePipe: DatePipe, public dialog: MatDialog) {
    ...
    downloadsafeoverview() {
        ...
        //api
        this._adxcontentoverviewService.downSafeVideoOverview(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
            .subscribe(dataResult => {
