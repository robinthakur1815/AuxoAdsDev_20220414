...
import { SafeRevenueDisplayGeoRoutes } from './safe-display-geo.routing';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild(SafeRevenueDisplayGeoRoutes)
  ],
  declarations: [SafeRevenueDisplayGeoComponent ]
})
export class SafeRevenueDisplayGeoModule {}