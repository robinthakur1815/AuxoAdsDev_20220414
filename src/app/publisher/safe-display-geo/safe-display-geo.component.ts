...
import { SafeRevenueDisplayGeoService } from './safe-display-geo.service';
declare var $: any;
...
@Component({
  selector: 'app-safe-display-geo',
  templateUrl: './safe-display-geo.component.html',
  styleUrls: ['./safe-display-geo.component.scss'],
  // Tooltip start
...
export class SafeRevenueDisplayGeoComponent implements OnInit {
  // Tooltip start
  ...
  constructor(private _displayGeoService: SafeRevenueDisplayGeoService, private datePipe: DatePipe, public dialog: MatDialog) { Highcharts.setOptions({
            lang: {
                thousandsSep: ','
            }
        });}
  ...
  ngOnInit() {
    ...
    //api
    this._displayGeoService.getSafeDisplayGeo(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
  ...
  findDetails(data) {
    ...
    const filterdata = this.tablerootdata.filter(y => y.geo === data.geo);
  ...
  downloadsafegeo() {
    ...
    //api
    this._displayGeoService.downSafeDisplayGeo(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
      .subscribe(dataResult => {
