...
import { SafeRevenueAppAdunitsService } from './safe-app-adunits.service';
declare var $: any;
...
@Component({
  selector: 'app-safe-app-adunits',
  templateUrl: './safe-app-adunits.component.html',
  styleUrls: ['./safe-app-adunits.component.scss'], 
   // Tooltip start
  ...
  export class SafeRevenueAppUnitsComponent implements OnInit {
         // Tooltip start
  ...
  constructor(private _appAdunitsService:SafeRevenueAppAdunitsService,private datePipe: DatePipe,public dialog: MatDialog) { Highcharts.setOptions({
            lang: {
                thousandsSep: ','
            }
        }); }
...
getchart(x,y,z,level){
    ...
    ngOnInit() {
     this.isSpinnerVisible = true;
         ...
         //api
         this._appAdunitsService.getSafeAppAdunit(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
   ...
   downloadsafeadunits(){
        ...
        //api
         this._appAdunitsService.downSafeAppAdunits(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
            .subscribe(dataResult => {
