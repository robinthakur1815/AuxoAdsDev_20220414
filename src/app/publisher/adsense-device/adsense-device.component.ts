...
import { AdsenseDeviceService } from './adsense-device.service';
declare var $: any;
...
@Component({
  selector: 'app-adsense-device',
  templateUrl: './adsense-device.component.html',
  styleUrls: ['./adsense-device.component.scss'], 
   // Tooltip start
  ...
  export class AdsenseDeviceComponent implements OnInit {
  tablerootdata = [];
  graphrootdata = [];
  sumupdata =[]; 
  lvl1data1 = [];
  ...
  sumuplvldata = {"adreq":"","adimpr":"","fillrate":"","covg":"","ctr":"","ecpm":"","revenue_cmsShare":""};
   constructor(private _adsDeviceService:AdsenseDeviceService,private datePipe: DatePipe,public dialog: MatDialog) { Highcharts.setOptions({
            lang: {
                thousandsSep: ','
            }
        }); }  
...
getchart(x,y,z,level){ 
 ...
 ngOnInit() {
         ...
         //api
         this._adsDeviceService.getAdsDevice(localStorage.getItem('uniq_id'), localStorage.getItem('startdate'), localStorage.getItem('enddate') , localStorage.getItem('ads_id'))
    ...
    downloadadsDevice(){
        ...
        //api
         this._adsDeviceService.downAdsDevice(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('ads_id'))
            .subscribe(dataResult => {
