...
import { SafeRevenueVideoGeoService } from './safe-video-geo.service';
declare var $: any;
...
@Component({
  selector: 'app-safe-video-geo',
  templateUrl: './safe-video-geo.component.html',
  styleUrls: ['./safe-video-geo.component.scss'],
  // Tooltip start
...
export class SafeRevenueVideoGeoComponent implements OnInit {
  // Tooltip start
  ...
  constructor(private _displayVideoService: SafeRevenueVideoGeoService, private datePipe: DatePipe, public dialog: MatDialog) { Highcharts.setOptions({
            lang: {
                thousandsSep: ','
            }
        });}
  ...
  ngOnInit() {
    ...
    //api
    this._displayVideoService.getSafeVideoGeo(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
  ...
  downloadsafegeo() {
    ...
    //api
    this._displayVideoService.downSafeVideoGeo(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
      .subscribe(dataResult => {
