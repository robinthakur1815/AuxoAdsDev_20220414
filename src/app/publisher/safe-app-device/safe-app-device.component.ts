...
import { SafeRevenueAppDeviceService } from './safe-app-device.service';
declare var $: any;
...
@Component({
  selector: 'app-safe-app-device',
  templateUrl: './safe-app-device.component.html',
  styleUrls: ['./safe-app-device.component.scss'],
  // Tooltip start
...
export class SafeRevenueAppDeviceComponent implements OnInit {
  // Tooltip start
  ...
  constructor(private _appDeviceService: SafeRevenueAppDeviceService, private datePipe: DatePipe, public dialog: MatDialog) { Highcharts.setOptions({
            lang: {
                thousandsSep: ','
            }
        });}
  ...
  ngOnInit() {
    ...
    //api
    this._appDeviceService.getSafeAppDevice(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
  ...
  downloadsafedevice() {
    ...
    //api
    this._appDeviceService.downSafeAppDevice(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
      .subscribe(dataResult => {
