...
import { SafeRevenueAppAdtypesService } from './safe-app-adtypes.service';
declare var $: any;
...
@Component({
  selector: 'app-safe-app-adtypes',
  templateUrl: './safe-app-adtypes.component.html',
  styleUrls: ['./safe-app-adtypes.component.scss'],
  // Tooltip start
...
export class SafeRevenueAppAdtypesComponent implements OnInit {
  tablerootdata = [];
  graphrootdata = [];
  tablerootdatainner = [];
  sumupdata = [];
  ...
  constructor(private _appAdtypesService: SafeRevenueAppAdtypesService, private datePipe: DatePipe, public dialog: MatDialog) {
...
Highcharts.setOptions({
  ...
  ngOnInit() {
    ...
    //api
    this._appAdtypesService.getSafeAppAdtypes(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
  ...
  downloadsafeadtypes() {
    ...
    //api
    this._appAdtypesService.downSafeAppAdtypes(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
      .subscribe(dataResult => {
