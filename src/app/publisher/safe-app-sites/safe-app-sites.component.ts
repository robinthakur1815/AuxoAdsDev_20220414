...
import { SafeRevenueAppSitesService } from './safe-app-sites.service';
declare var $: any;
...
@Component({
  selector: 'app-safe-app-sites',
  templateUrl: './safe-app-sites.component.html',
  styleUrls: ['./safe-app-sites.component.scss'],
  // Tooltip start
...
export class SafeRevenueAppSitesComponent implements OnInit {
  // Tooltip start
  ...
  constructor(private _appSitesService: SafeRevenueAppSitesService, private datePipe: DatePipe, public dialog: MatDialog) { }
  expandContent = true;
  ...
  ngOnInit() {
    ...
    //api
    this._appSitesService.getSafeAppSites(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
  ...
  downloadsafesites() {
    ...
    //api
    this._appSitesService.downSafeAppSites(localStorage.getItem('startdate'), localStorage.getItem('enddate'), localStorage.getItem('uniq_id'), localStorage.getItem('child_net_code'), localStorage.getItem('range'))
      .subscribe(dataResult => {
